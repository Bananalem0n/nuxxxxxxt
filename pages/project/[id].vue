<template>
  <div
    class="w-full min-h-screen max-h-fit dark:bg-gunmetal bg-background px-4 sm:px-6 md:px-8 lg:px-10 xl:px-16 2xl:px-28 pt-20 sm:pt-28"
  >
    ...
    <h1
      id="title"
      class="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-ubuntu 2xl:pt-8 sm:pt-6"
    >
        ...
        >
          <a :href="data.links" target="_blank">
            <div id="provider" class="w-full min-h-fit mb-5">
              <span
                class="flex flex-row bg-purp py-3 px-4 sm:px-6 md:px-7 rounded-md shadow-lg items-center"
              >
                <Icon
                  :name="data.icon"
                  color="white"
                  class="mr-2 sm:mr-3 md:mr-4 size-6 sm:size-7 md:size-8 lg:size-9 xl:size-10"
                />
                <div
                  class="font-josefin text-sm sm:text-base md:text-lg lg:text-xl mt-auto mx-auto 2xl:pb-1"
                >
                  {{ data.provider }}
                </div>
              </span>
